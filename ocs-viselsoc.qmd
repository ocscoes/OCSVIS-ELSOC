...
::::{.columns}
:::{.column width="100%"}
![](www/img/elsoc-hor.png)
:::

:::{.column width="100%"}
![](www/img/elsoc-ver.png)
:::
::::
...
output$subdims_plot <- plotly::renderPlotly({
 ...
 p %>%
   plotly::layout(
     ...
     annotations = list(
       list(
         text = "FUente: Encuesta Longitudinal Social de Chile (ELSOC), COES. N = XXX (individuos)",
       ...
       list(
         text = "(2): Los puntos ausentes en las olas significan que no hay datos disponibles para ese año.",
         xref = "paper", yref = "paper",
         x = 0, y = -0.24,
         xanchor = "left", yanchor = "top",
         align = "left",
...
dat_filtered <- reactive({
  ...
  output$plot_bivariado <- plotly::renderPlotly({
   ...
   plotly::plot_ly(
    ...
    plotly::layout(
      title = paste0("Subdimensión: ", input$subdim_select,
                     " | Categoría: ", input$Categoria_select),
      xaxis = list(title = "Ola"),
